...
namespace LRC
{
  public partial class RelatedItem : UserControl
  {
Grid LayoutRoot;
Image Image;
...
StarRatingControl StarRating;
    ...
    public RelatedItem() => this.InitializeComponent();
    ...
    // {
      ...
      Application.LoadComponent((object) this, new Uri("/LRC;component/UI/Controls/Search/RelatedItem.xaml", UriKind.Relative));
