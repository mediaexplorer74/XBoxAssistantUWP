// *********************************************************
// Type: LRC.LocalSubnet.LRC_JOIN_SESSION_REQUEST
...
{
  public class LRC_JOIN_SESSION_REQUEST : LRC_REQUEST
  {
    public LRC_JOIN_SESSION_REQUEST()
    {
      this.Header.MessageType = 2147483649U;
