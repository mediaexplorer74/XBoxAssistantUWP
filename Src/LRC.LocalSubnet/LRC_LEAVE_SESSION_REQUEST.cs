// *********************************************************
// Type: LRC.LocalSubnet.LRC_LEAVE_SESSION_REQUEST
...
{
  public class LRC_LEAVE_SESSION_REQUEST : LRC_REQUEST
  {
    public LRC_LEAVE_SESSION_REQUEST()
    {
      this.Header.MessageType = 2147483650U;
